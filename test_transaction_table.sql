...
DROP TABLE IF EXISTS warehouse.bo_testing.dm_user_transactions_dwt_daily;

CREATE TABLE IF NOT EXISTS warehouse.bo_testing.dm_user_transactions_dwt_daily 
(
...
CREATE INDEX IF NOT EXISTS idx_dm_user_transactions_dwt_daily ON warehouse.bo_testing.dm_user_transactions_dwt_daily 
(created_at, signup_hostcountry, ap_account_id, product_1_symbol);

ALTER TABLE warehouse.bo_testing.dm_user_transactions_dwt_daily REPLICA IDENTITY FULL;
...
INSERT INTO warehouse.bo_testing.dm_user_transactions_dwt_daily (invitation_code, user_id, created_at , signup_hostcountry , ap_account_id
...
DELETE FROM warehouse.bo_testing.dm_user_transactions_dwt_daily WHERE created_at >= NOW()::DATE - '1 day'::INTERVAL;